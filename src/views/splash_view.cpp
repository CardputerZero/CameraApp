...
void launch_size_anim_cb(lv_anim_t* anim, int32_t value)
{
    ...
    const int32_t height = kLaunchStartSize + ((state->target_height - kLaunchStartSize) * value) / 256;
...
void SplashView::build_exit_hint_() {
    ...
    lv_obj_set_flex_align(exit_hint_container_, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER, LV_FLEX_ALIGN_CENTER);
