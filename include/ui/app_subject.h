...
public:
    explicit SubjectInt(int32_t value = 0)
    {
    ...
    {
        lv_subject_set_min_value_int(&subject_, value);
    }

    void set_max(int32_t value)
    {
        lv_subject_set_max_value_int(&subject_, value);
    }
};
...
public:
    ...
    void set(bool value)
    {
        SubjectInt::set(value ? 1 : 0);
    }

    bool get() const
    {
        return SubjectInt::get() != 0;
    }

    bool previous() const
    {
        return SubjectInt::previous() != 0;
    }
};
...
public:
    explicit SubjectFloat(float value = 0.0f)
    {
    ...
    {
        lv_subject_set_float(&subject_, value);
    }
    ...
    {
        lv_subject_set_min_value_float(&subject_, value);
    }

    void set_max(float value)
    {
        lv_subject_set_max_value_float(&subject_, value);
    }
};
#endif
...
public:
    ...
    {
        lv_subject_init_string(&subject_, buffer_.data(), previous_buffer_.data(), Size, value ? value : "");
    }
    ...
    {
        lv_subject_copy_string(&subject_, value ? value : "");
    }
...
public:
    explicit SubjectPointer(void* value = nullptr)
    {
    ...
    void set(void* value)
    {
        lv_subject_set_pointer(&subject_, value);
    }

    const void* get() const
    {
        return lv_subject_get_pointer(const_cast<lv_subject_t*>(&subject_));
    }
...
public:
    ...
    {
        lv_subject_set_color(&subject_, value);
    }
...
public:
    ...
    explicit SubjectGroup(const std::vector<lv_subject_t*>& subjects)
    {
        init(subjects);
    }

    explicit SubjectGroup(const std::vector<SubjectBase*>& subjects)
    {
        init(subjects);
    }
    ...
    lv_subject_t* element(int32_t index)
    {
        return lv_subject_get_group_element(&subject_, index);
    }
