...
void SdlKeypad::poll()
{
    ...
    const bool confirm_pressed     = state[SDL_SCANCODE_RETURN] != 0 ||
    state[SDL_SCANCODE_KP_ENTER]  != 0;
    const bool delete_pressed      = state[SDL_SCANCODE_DELETE] != 0 ||
    state[SDL_SCANCODE_BACKSPACE] != 0;
